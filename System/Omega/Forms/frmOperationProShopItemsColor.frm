...
Begin VB.Form frmOperationProShopItemsColor 
   BackColor       =   &H00C6B8A4&
   ...
   Begin RPVGCC.b8Container picAddEdit 
      ...
      Begin RPVGCC.b8TitleBar b8TitleBar5 
         ...
         font            =   "frmOperationProShopItemsColor.frx":0000
         fontbold        =   -1  'True
         fontname        =   "Tahoma"
         fontsize        =   8.25
         autofunction    =   0   'False
         icon            =   "frmOperationProShopItemsColor.frx":0028
      End
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.CommandButton cmdClose 
         ...
         Height          =   495
         Left            =   6240
         MouseIcon       =   "frmOperationProShopItemsColor.frx":05C4
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   495
         Left            =   6240
         MouseIcon       =   "frmOperationProShopItemsColor.frx":08CE
         MousePointer    =   99  'Custom
         TabIndex        =   9
         Top             =   960
         Width           =   855
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   495
         Left            =   6240
         MouseIcon       =   "frmOperationProShopItemsColor.frx":0BD8
         MousePointer    =   99  'Custom
         TabIndex        =   10
         Top             =   480
         Width           =   855
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   495
         Left            =   6240
         MouseIcon       =   "frmOperationProShopItemsColor.frx":0EE2
         MousePointer    =   99  'Custom
         TabIndex        =   11
         Top             =   0
         Width           =   855
   ...
   End
End
Attribute VB_Name = "frmOperationProShopItemsColor"
...
With lstRecords.ListItems
    .Clear
    s = "SELECT tbl_Operation_ProShop_Items_Color.* " & _
        " FROM tbl_Operation_ProShop_Items_Color " & _
        " WHERE (Visible = 1) " & _
        " ORDER BY ProItemsColor "
    If rs.State = adStateOpen Then rs.Close
    rs.Open s, ConnOmega
    While Not rs.EOF
        Set x = .Add()
        x.Text = rs!PK
        x.SubItems(1) = rs!ProItemsColor
        rs.MoveNext
    Wend
    rs.Close
End With
...
If AccessRights("Pro Shop Items (Color)", "Add") = False Then
...
If picAddEdit.Visible = True Then Exit Sub
If AccessRights("Pro Shop Items (Color)", "Delete") = False Then
    MsgBox "INSUFICIENT RIGHTS TO PERFORM THIS OPERATION.       " & vbCrLf & _
           "ACCESS DENIED!                                      ", vbCritical, "Alert"
    Exit Sub
End If
With lstRecords.ListItems
    ...
    On Error GoTo PG:
    ConnOmega.Execute "DELETE FROM tbl_Operation_ProShop_Items_Color WHERE (PK = " & .Item(iRow).Text & ")"
    .Remove iRow
...
If picAddEdit.Visible = True Then Exit Sub
If AccessRights("Pro Shop Items (Color)", "Edit") = False Then
    MsgBox "INSUFICIENT RIGHTS TO PERFORM THIS OPERATION.       " & vbCrLf & _
           "ACCESS DENIED!                                      ", vbCritical, "Alert"
    Exit Sub
End If
...
iFocus = 1
u = "SELECT tbl_Operation_ProShop_Items_Color.* " & _
    " FROM tbl_Operation_ProShop_Items_Color " & _
...
If KeyCode = vbKeyReturn Then
    On Error GoTo PG:
    If TRANSACTIONTYPE = is_ADDING Then
        ConnOmega.Execute "INSERT INTO tbl_Operation_ProShop_Items_Color " & _
                         " (ProItemsColor, LastModified) " & _
                         " VALUES ('" & FORMATSQL(Trim(txtDestination.Text)) & "', " & _
                         " '" & CStr(Now) & " - " & gbl_CompleteName & "')"
        t = "SELECT PK " & _
            " FROM tbl_Operation_ProShop_Items_Color " & _
            " WHERE (ProItemsColor = '" & FORMATSQL(Trim(txtDestination.Text)) & "')"
    ...
    End If
    If TRANSACTIONTYPE = is_EDITTING Then
        ConnOmega.Execute "UPDATE tbl_Operation_ProShop_Items_Color " & _
                         " SET ProItemsColor = '" & FORMATSQL(Trim(txtDestination.Text)) & "', " & _
