...
Begin VB.Form frmPhilHealthTable 
   BackColor       =   &H00C6B8A4&
   ...
   EndProperty
   Icon            =   "frmPhilHealthTable.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":09CC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":0B50
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":0E6A
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":1223
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":1675
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":1AC7
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":1E7F
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":1F91
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":24D3
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":262D
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPhilHealthTable.frx":2B6F
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmPhilHealthTable"
...
s = "SELECT tbl_Personnel_PhilHealthTable.Bracket, " & _
    " tbl_Personnel_PhilHealthTable.[From], " & _
    " tbl_Personnel_PhilHealthTable.[To], " & _
    " tbl_Personnel_PhilHealthTable.EmployerShare, " & _
    " tbl_Personnel_PhilHealthTable.EmployeeShare, " & _
    " tbl_Personnel_PhilHealthTable.PK " & _
    " From tbl_Personnel_PhilHealthTable " & _
    " ORDER BY tbl_Personnel_PhilHealthTable.Bracket"
...
'If AccessRights("Personnel PHIC Table", "Add") = False Then
...
'Me.Caption = "PHIL HEALTH TABLE - NEW"
End Function

Private Function PRESS_F2()
If TRANSACTIONTYPE <> is_REFRESH Then Exit Function
'If AccessRights("Personnel PHIC Table", "Edit") = False Then
'    MsgBox "INSUFICIENT RIGHTS TO PERFORM THIS OPERATION.       " & vbCrLf & _
'           "ACCESS DENIED!                                      ", vbCritical, "Alert"
'    Exit Function
'End If
...
txtFrom.SetFocus
lstPHICDetail.Enabled = False
'Me.Caption = "PHIL HEALTH TABLE - EDIT"
End Function

Private Function DELETE_PHIC(intPK)

s = "DELETE FROM tbl_Personnel_PhilHealthTable " & _
    " WHERE (PK = " & intPK & ") "
...
If TRANSACTIONTYPE <> is_REFRESH Then Exit Function
'If AccessRights("Personnel PHIC Table", "Delete") = False Then
'    MsgBox "INSUFICIENT RIGHTS TO PERFORM THIS OPERATION.       " & vbCrLf & _
'           "ACCESS DENIED!                                      ", vbCritical, "Alert"
'    Exit Function
'End If
...
DELETE_PHIC lstPHICDetail.ListItems.Item(ROW).Text
LOAD_TABLE
...
s = "INSERT INTO tbl_Personnel_PhilHealthTable " & _
...
s = "UPDATE tbl_Personnel_PhilHealthTable " & _
...
If TRANSACTIONTYPE = is_ADDING Then
    ...
    'Me.Height = 4515
    'Me.Caption = "PHIL HEALTH TABLE - BROWSE"
...
Select Case Button.Key
    ...
    Case "First"
        Select Case Toolbar1.Buttons(7).Caption
            Case "Save":  PRESS_F5
            Case "First": lstPHICDetail.ListItems(1).EnsureVisible: lstPHICDetail.ListItems(1).Selected = True: ROW = 1
        End Select
    Case "Back"
