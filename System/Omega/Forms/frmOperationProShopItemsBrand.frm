...
Begin VB.Form frmOperationProShopItemsBrand 
   BackColor       =   &H00C6B8A4&
   ...
   Begin RPVGCC.b8Container picAddEdit 
      ...
      Begin RPVGCC.b8TitleBar b8TitleBar5 
         ...
         Icon            =   "frmOperationProShopItemsBrand.frx":0000
      End
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.CommandButton cmdClose 
         ...
         Height          =   495
         Left            =   6240
         MouseIcon       =   "frmOperationProShopItemsBrand.frx":059A
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   495
         Left            =   6240
         MouseIcon       =   "frmOperationProShopItemsBrand.frx":08A4
         MousePointer    =   99  'Custom
         TabIndex        =   8
         Top             =   960
         Width           =   855
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   495
         Left            =   6240
         MouseIcon       =   "frmOperationProShopItemsBrand.frx":0BAE
         MousePointer    =   99  'Custom
         TabIndex        =   9
         Top             =   480
         Width           =   855
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   495
         Left            =   6240
         MouseIcon       =   "frmOperationProShopItemsBrand.frx":0EB8
         MousePointer    =   99  'Custom
         TabIndex        =   10
         Top             =   0
         Width           =   855
   ...
   End
End
Attribute VB_Name = "frmOperationProShopItemsBrand"
...
With lstRecords.ListItems
    .Clear
    s = "SELECT tbl_Operation_ProShop_Items_Brand.* " & _
        " FROM tbl_Operation_ProShop_Items_Brand " & _
        " WHERE (Visible = 1) " & _
        " ORDER BY ProItemsBrand "
    If rs.State = adStateOpen Then rs.Close
    rs.Open s, ConnOmega
    While Not rs.EOF
        Set x = .Add()
        x.Text = rs!PK
        x.SubItems(1) = rs!ProItemsBrand
        rs.MoveNext
    Wend
    rs.Close
End With
...
If AccessRights("Pro Shop Items (Brand)", "Add") = False Then
...
If picAddEdit.Visible = True Then Exit Sub
If AccessRights("Pro Shop Items (Brand)", "Delete") = False Then
    MsgBox "INSUFICIENT RIGHTS TO PERFORM THIS OPERATION.       " & vbCrLf & _
           "ACCESS DENIED!                                      ", vbCritical, "Alert"
    Exit Sub
End If
With lstRecords.ListItems
    ...
    On Error GoTo PG:
    ConnOmega.Execute "DELETE FROM tbl_Operation_ProShop_Items_Brand WHERE (PK = " & .Item(iRow).Text & ")"
    .Remove iRow
...
If picAddEdit.Visible = True Then Exit Sub
If AccessRights("Pro Shop Items (Brand)", "Edit") = False Then
    MsgBox "INSUFICIENT RIGHTS TO PERFORM THIS OPERATION.       " & vbCrLf & _
           "ACCESS DENIED!                                      ", vbCritical, "Alert"
    Exit Sub
End If
...
iFocus = 1
u = "SELECT tbl_Operation_ProShop_Items_Brand.* " & _
    " FROM tbl_Operation_ProShop_Items_Brand " & _
...
If KeyCode = vbKeyReturn Then
    On Error GoTo PG:
    If TRANSACTIONTYPE = is_ADDING Then
        ConnOmega.Execute "INSERT INTO tbl_Operation_ProShop_Items_Brand " & _
                         " (ProItemsBrand, LastModified) " & _
                         " VALUES ('" & FORMATSQL(Trim(txtDestination.Text)) & "', " & _
                         " '" & CStr(Now) & " - " & gbl_CompleteName & "')"
        t = "SELECT PK " & _
            " FROM tbl_Operation_ProShop_Items_Brand " & _
            " WHERE (ProItemsBrand = '" & FORMATSQL(Trim(txtDestination.Text)) & "')"
    ...
    End If
    If TRANSACTIONTYPE = is_EDITTING Then
        ConnOmega.Execute "UPDATE tbl_Operation_ProShop_Items_Brand " & _
                         " SET ProItemsBrand = '" & FORMATSQL(Trim(txtDestination.Text)) & "', " & _
